...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| LOGIN-011 | Password field masking | None | 1. Navigate to login page<br>2. Enter text in password field | Password characters are masked/hidden | High |
| LOGIN-012 | Tab navigation | None | 1. Navigate to login page<br>2. Use Tab key to navigate between fields | Focus moves in logical order: username → password → Log In button | Medium |
| LOGIN-013 | Enter key submission | None | 1. Fill in credentials<br>2. Press Enter key | Form submits (same as clicking Log In) | Medium |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| REG-016 | Password masking | None | 1. Type in Password field | Characters are masked | High |
| REG-017 | Confirm Password masking | None | 1. Type in Confirm Password field | Characters are masked | High |
| REG-018 | Form field order | None | 1. Tab through form | Logical top-to-bottom order | Medium |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| ONA-007 | Account type dropdown | User logged in | 1. Click account type dropdown | Shows Checking and Savings options | Medium |
| ONA-008 | Funding source dropdown | User logged in | 1. Click funding source dropdown | Shows all user's existing accounts | Medium |
| ONA-009 | Menu highlight | User logged in | 1. Navigate to Open New Account | "Open New Account" is highlighted in left menu | Low |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| AO-005 | Column headers | User logged in | 1. View Accounts Overview | Headers: Account, Balance, Available Amount visible | Medium |
| AO-006 | Menu highlight | User logged in | 1. Navigate to Accounts Overview | "Accounts Overview" highlighted in left menu | Low |
| AO-007 | Balance formatting | User logged in | 1. View account balances | Currency formatted correctly (e.g., $1,234.56) | Medium |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| TF-011 | Form elements displayed | User logged in | 1. Navigate to Transfer Funds | Amount field, From dropdown, To dropdown, Transfer button visible | Medium |
| TF-012 | Account dropdowns populated | User logged in with accounts | 1. Click dropdowns | All user accounts listed | Medium |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| FT-014 | Four search panels visible | User logged in | 1. View Find Transactions page | All four search panels visible: By ID, By Date, By Date Range, By Amount | Medium |
| FT-015 | Results table format | Search returns results | 1. View results | Table shows Transaction ID, Date, Description, Amount | Medium |
...
| TC ID | Test Case | Preconditions | Steps | Expected Result | Priority |
|-------|-----------|---------------|-------|-----------------|----------|
| LO-004 | Logout link visibility | User logged in | 1. View left menu | "Log Out" link visible in Account Services menu | Medium |
...
| Registration | 18 | 15 | 3 | 0 |
| Open New Account | 9 | 4 | 4 | 1 |
| Account Overview | 7 | 2 | 4 | 1 |
| Transfer Funds | 12 | 5 | 4 | 3 |
| Bill Pay | 15 | 13 | 2 | 0 |
| Find Transactions | 15 | 8 | 4 | 3 |
